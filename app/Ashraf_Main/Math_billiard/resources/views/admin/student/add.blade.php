...
<head>
  ...
  <title>AdminLTE 3 | Add New Student</title>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="class_id">
                            ...
                            <option {{ (old('class_id') == 1) ? 'selected' : '' }} value="1">P.7 finalist</option>
                            <option {{ (old('class_id') == 2) ? 'selected' : '' }} value="2">P.4 - P.6 continuing</option>
                        </select>
