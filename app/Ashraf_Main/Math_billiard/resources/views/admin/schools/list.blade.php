  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Registered Schools (Total : {{ $getRecord->total() }})</h1>
          </div>
          <div class="col-sm-6" style="text-align:right">
            <a href="{{url('admin/schools/add')}}" class="btn btn-primary">Register New School </a>
          </div>
               ...
               @if ($errors->any())
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-3 align-self-end">
                        ...
                        <a href={{ url('admin/schools/list')}} class="btn btn-primary" style="margin-top: 25px">Reset</a>
                    </div>
                  ...
                  <tbody>
                    @foreach($getRecord as $value)
                      ...
                      <td>{{ $value->id }}</td>
                        ...
                        <td>
                          <a href="{{ url('admin/schools/edit/' .$value->id) }}" class="btn btn-primary">Edit</a>
                          <a href="{{ url('admin/schools/delete/' .$value->id) }}" class="btn btn-danger">Delete</a>
